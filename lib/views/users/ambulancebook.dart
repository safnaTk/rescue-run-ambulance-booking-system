...
class BookAmbulance extends StatefulWidget {
  ...
  String?cat;
  String?hid;
  BookAmbulance({Key? key,this.hid, this.cat,this.ampid,this.driverPhone,this.drivername,this.location}) : super(key: key);
