...
class ViewAllFeedbacksUsers extends StatefulWidget {
  String?userid;
  ViewAllFeedbacksUsers({Key? key,this.userid }) :super(key: key);

  @override
  State<ViewAllFeedbacksUsers> createState() => _ViewAllFeedbacksUsersState();
}

class _ViewAllFeedbacksUsersState extends State<ViewAllFeedbacksUsers> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: FutureBuilder(
            future: _feedbackService.getFeedbackuser(widget.userid),
