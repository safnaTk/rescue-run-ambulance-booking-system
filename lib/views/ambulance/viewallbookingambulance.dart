...
class ViewAllBookingAmbulance extends StatefulWidget {
  String? id;

  ViewAllBookingAmbulance({Key? key, this.id}) : super(key: key);

  @override
  State<ViewAllBookingAmbulance> createState() => _ViewAllBookingAmbulanceState();
}

class _ViewAllBookingAmbulanceState extends State<ViewAllBookingAmbulance> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: FutureBuilder(
            future: _ambulanceService.getAllBookingAmbulance(widget.id),
