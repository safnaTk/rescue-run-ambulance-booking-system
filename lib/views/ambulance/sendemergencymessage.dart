...
class SendEmergencyMessage extends StatefulWidget {
  String? hid;
  SendEmergencyMessage({Key? key, this.hid}) : super(key: key);

  @override
  State<SendEmergencyMessage> createState() => _SendEmergencyMessageState();
}

class _SendEmergencyMessageState extends State<SendEmergencyMessage> {
  String? sender;
  getData() async {
