...
class ViewAllAmbulances extends StatefulWidget {
  String?hid;
  String?type;
  ViewAllAmbulances({Key? key, this.type,this.hid}) : super(key: key);

  @override
  State<ViewAllAmbulances> createState() => _ViewAllAmbulancesState();
}

class _ViewAllAmbulancesState extends State<ViewAllAmbulances> {
    ...
    return Scaffold(
        ...
        body: SafeArea(
          child: FutureBuilder(
            ...
            // changed
              future: _ambulanceService.GetAllAmbulancebyhid(widget.hid.toString()),
