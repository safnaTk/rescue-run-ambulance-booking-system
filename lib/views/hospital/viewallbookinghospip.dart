...
class ViewAllBookingHosIp extends StatefulWidget {
  String? id;

  // const ViewAllBookingHosIp({super.key,this.id});
  ViewAllBookingHosIp({Key? key, this.id, }) : super(key: key);

  @override
  State<ViewAllBookingHosIp> createState() => _ViewAllBookingHosIpState();
}

class _ViewAllBookingHosIpState extends State<ViewAllBookingHosIp> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: FutureBuilder(
            ...
            future: _ambulanceService.getAllBookingHospitalIP(widget.id),
