...
class ViewAllBookingHos extends StatefulWidget {
  String? id;

  // const ViewAllBookingHosIp({super.key,this.id});
  ViewAllBookingHos({Key? key, this.id, }) : super(key: key);

  @override
  State<ViewAllBookingHos> createState() => _ViewAllBookingHosState();
}

class _ViewAllBookingHosState extends State<ViewAllBookingHos> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: FutureBuilder(
            future: _ambulanceService.getAllBookingHs(widget.id),
